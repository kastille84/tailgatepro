...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Every completed talk is emailed to your GC as a PDF link that stays valid for 30 days, so save a copy if you need it longer. The Free plan's in-app history shows the last 30 days; the 5-year legal cloud archive on Trade Pro is coming soon.",
  },
  {
