...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Every completed talk is emailed to your GC as a PDF link that stays valid for 30 days, so save a copy if you need it longer. A 30-day in-app history window for the Free plan and the 5-year legal cloud archive on Trade Pro are coming soon.",
  },
  {
